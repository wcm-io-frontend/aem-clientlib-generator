 ...
 * @property {Array<String>} [customProperties] - allow more that the default set of properties
...
function processItem(item, options, processDone) {
  ...
  clientLibDirectoryFields = clientLibDirectoryFields.concat(item.customProperties);
